...
#define gRatio 42		// knee:30.8=44/60*42 other:42
#endif
...
#define POS_ID 		0x101
#define REQ_ID 		0x103
#define ECHO_ID		0x7FE
#define ESTOP_ID 	0x7FF
/* USER CODE END PTD */
...
const float plim = PI * 3 / 4;
const float nlim = -PI * 3 / 4;
enum ERROR_STATE {
	nominal, CAN_lost, out_of_range, fault_yet, other
} errorID = nominal;
int flag = 0;
uint8_t demo[8] = {0,0,0,0,0,0,0,0};
...
//	MC_StartMotor1();
  ...
  /* USER CODE BEGIN WHILE */
	while (1) {
//		MC_ProgramPositionCommandMotor1(2*PI, 3);
//		HAL_Delay(1000);
//		MC_ProgramPositionCommandMotor1(0, 3);
//		HAL_Delay(1000);
